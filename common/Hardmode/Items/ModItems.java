...
public class ModItems 
{
    ...
    public static void InitializeItems()
    {
        ...
        AncientShard = (new BaseItem(ItemIds.ANCIENT_SHARD, Names.ANCIENT_SHARD));
    	EnderShard = (new BaseItem(ItemIds.ENDER_SHARD, Names.ENDER_SHARD));
    	LavaShard = (new BaseItem(ItemIds.LAVA_SHARD, Names.LAVA_SHARD));
    	MoonStoneShard = (new BaseItem(ItemIds.MOON_STONE_SHARD, Names.MOON_STONE_SHARD));
    	TunarusShard = (new BaseItem(ItemIds.TUNARUS_SHARD, Names.TUNARUS_SHARD));
    	UtaranShard = (new BaseItem(ItemIds.UTARAN_SHARD, Names.UTARAN_SHARD));
    	WretechedShard = (new BaseItem(ItemIds.WRETCHED_SHARD, Names.WRETCHED_SHARD));
    	AncientCluster = (new BaseItem(ItemIds.ANCIENT_CLUSTER, Names.ANCIENT_CLUSTER));
    	EnderCluster = (new BaseItem(ItemIds.ENDER_CLUSTER, Names.ENDER_CLUSTER));
    	LavaCluster = (new BaseItem(ItemIds.LAVA_CLUSTER, Names.LAVA_CLUSTER));
    	MoonStoneCluster = (new BaseItem(ItemIds.MOON_STONE_CLUSTER, Names.MOON_STONE_CLUSTER));
    	TunarusCluster = (new BaseItem(ItemIds.TUNARUS_CLUSTER, Names.TUNARUS_SHARD));
    	UtaranCluster = (new BaseItem(ItemIds.UTARAN_CLUSTER, Names.UTARAN_CLUSTER));
    	WretechedCluster = (new BaseItem(ItemIds.WRETCHED_CLUSTER, Names.WRETCHED_CLUSTER));
    	AncientIngot = (new BaseItem(ItemIds.ANCIENT_CLUSTER, Names.ANCIENT_CLUSTER));
    	EnderIngot = (new BaseItem(ItemIds.ENDER_INGOT, Names.ENDER_INGOT));
    	LavaIngot = (new BaseItem(ItemIds.LAVA_INGOT, Names.LAVA_INGOT));
    	MoonStoneIngot = (new BaseItem(ItemIds.MOON_STONE_INGOT, Names.MOON_STONE_INGOT));
    	TunarusIngot = (new BaseItem(ItemIds.TUNARUS_INGOT, Names.TUNARUS_INGOT));
    	UtaranIngot = (new BaseItem(ItemIds.UTARAN_INGOT, Names.UTARAN_INGOT));
    	WretechedIngot = (new BaseItem(ItemIds.WRETCHED_INGOT, Names.WRETCHED_INGOT));
