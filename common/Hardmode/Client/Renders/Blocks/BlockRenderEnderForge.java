...
public class BlockRenderEnderForge implements IItemRenderer 
{
    private ModelEnderForge BlockModel;
    
    public BlockRenderEnderForge() 
    {
        BlockModel = new ModelEnderForge();
    }
