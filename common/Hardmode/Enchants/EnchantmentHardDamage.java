...
public class EnchantmentHardDamage extends Enchantment
{
    /** Holds the name to be translated of each protection type. */
    private static final String[] protectionName = new String[] {"Enhanced Sharpness", "Fight of the Fallen", "Destruction of the Dark", "Wrath of the Wretched", "Agony to the Ancient"};

    /**
     * Holds the base factor of enchantability needed to be able to use the enchant.
     */
    private static final int[] baseEnchantability = new int[] {-1, -1, -1, -1, -1};//{1, 5, 5, 5, 5};

    /**
     * Holds how much each level increased the enchantability factor to be able to use this enchant.
     */
    private static final int[] levelEnchantability = new int[] {-1, -1, -1, -1, -1};//{11, 8, 8, 8, 8};

    /**
     * Used on the formula of base enchantability, this is the 'window' factor of values to be able to use thing
     * enchant.
     */
    private static final int[] thresholdEnchantability = new int[] {-1, -1, -1, -1, -1};//{20, 20, 20, 20, 20};
    ...
    public EnchantmentHardDamage(int par1, int par2, int par3)
    {
    ...
    {
        return protectionName[this.damageType];
    }
    ...
    {
        return !(par1Enchantment instanceof EnchantmentHardDamage);
    }
